...
export function Contact() {
  return (
    <div className="perspective-container w-full mt-4">
      <section 
        id="contact"
        className="contact-card p-8 sm:p-10 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-sm hover:shadow-md hover:border-neutral-200 dark:hover:border-neutral-700 transition-all relative overflow-hidden group scroll-animate opacity-0" 
      >
        {/* Dynamic Glare Overlay */}
        <div className="contact-glare absolute inset-0 pointer-events-none opacity-0 z-20 transition-opacity duration-300"></div>

        <div className="relative z-10">
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-3 tracking-tight">
            Get in touch
          </h2>
