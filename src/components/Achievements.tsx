    ...
    <section className="scroll-animate">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {achievements.map((item) => (
          <div 
            key={item.title} 
            className="achievement-card flex gap-4 p-5 rounded-2xl bg-white dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800 shadow-sm hover:border-neutral-200 dark:hover:border-neutral-700 transition-all opacity-0"
          >
